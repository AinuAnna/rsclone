...
<tbody>
    ${users
      .map(
        (item) =>
          `<tr data-id="${item.id}"><td class="name">${item.fullName}</td><td class="mail">${item.mail}</td><td class="type">${item.type}</td><td class="description">${item.description}</td><td class="table__action">
