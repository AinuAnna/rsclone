...
export default class Admin extends UI {
  ...
  renderM() {
    ...
    this.usersArray.forEach(({ fullName, id, mail, type, description }) => {
      ...
      svgButtonEdit.setAttribute('data-bs-toggle', 'modal');
      svgButtonEdit.setAttribute('href', '#');
      svgButtonEdit.setAttribute('data-bs-target', '#editUserModal');
      svgButtonEdit.setAttribute('data-bs-userid', id);
      ...
      svgButtonDelete.setAttribute('data-bs-toggle', 'modal');
      svgButtonDelete.setAttribute('href', '#');
      svgButtonDelete.setAttribute('data-bs-target', '#deleteUserModal');
      svgButtonDelete.setAttribute('data-bs-userid', id);
    });
